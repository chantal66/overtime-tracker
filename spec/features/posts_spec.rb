...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized',
       email: 'non_authorized_user@email.com', password: 'asdfasdf', password_confirmation: 'asdfasdf', phone: '7208221211')
      post_from_other_user = Post.create(date: Date.today, rationale: "This post should'nt be seen", user_id: other_user.id, phone: '5555555555')
  ...
  describe 'new' do
    it 'has a link from the homeapage' do
      visit root_path
